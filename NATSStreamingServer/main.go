...
Streaming NATSStreamingServer Options:
    ...
    -ns,  --nats_server <string>         Connect to this external NATS NATSStreamingServer URL (embedded otherwise)
    -sc,  --stan_config <string>         Streaming server configuration file
    -hbi, --hb_interval <duration>       Interval at which server sends heartbeat to a client
    -hbt, --hb_timeout <duration>        How long server waits for a heartbeat response
    -hbf, --hb_fail_count <int>          Number of failed heartbeats before server closes the client connection
          --ft_group <string>            Name of the FT Group. A group can be 2 or more servers with a single active server and all sharing the same datastore
    -sl,  --signal <signal>[=<pid>]      Send signal to nats-streaming-server process (stop, quit, reopen, reload - only for embedded NATS NATSStreamingServer)
...
Streaming NATSStreamingServer Clustering Options:
...
Streaming NATSStreamingServer File Store Options:
...
Streaming NATSStreamingServer SQL Store Options:
...
Streaming NATSStreamingServer TLS Options:
    -secure <bool>                   Use a TLS connection to the NATS server without
                                     verification; weaker than specifying certificates.
    -tls_client_key <string>         publisher key for the streaming server
    -tls_client_cert <string>        publisher certificate for the streaming server
    -tls_client_cacert <string>      publisher certificate CA for the streaming server

Streaming NATSStreamingServer Logging Options:
...
Embedded NATS NATSStreamingServer Options:
...
TLS Options:
        ...
        --tlscert <string>           NATSStreamingServer certificate file
        --tlskey <string>            Private key for server certificate
        --tlsverify=<bool>           Enable TLS, verify client certificates
        --tlscacert <string>         publisher certificate CA for verification
